...
const Login: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex">
      {/* Left Panel - Branding */}
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-primary via-primary/90 to-purple-600 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center px-12 xl:px-20 text-primary-foreground">
          <div className="flex items-center gap-3 mb-8">
            ...
            <span className="text-2xl font-display font-bold">FormCraft</span>
          </div>
          ...
          <p className="text-lg text-white/70 mb-8 max-w-md">
            Create stunning, responsive forms with drag-and-drop simplicity. 
          ...
          <div className="flex flex-col gap-4">
            <div className="flex items-center gap-3">
              ...
              <span className="text-white/90">Drag & drop form builder</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 rounded-full bg-white/20 flex items-center justify-center">
                <Sparkles className="w-4 h-4" />
              </div>
              <span className="text-white/90">Real-time response tracking</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 rounded-full bg-white/20 flex items-center justify-center">
                <Sparkles className="w-4 h-4" />
              </div>
              <span className="text-white/90">Export to CSV & Excel</span>
            </div>
          </div>
        </div>
